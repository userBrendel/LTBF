...
type SectionKey = "intro" | "mission" | "vision" | "values" | "quote";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Authenticity",
                desc: "Every scent tells a genuine story",
                icon: "✨",
              },
              {
                title: "Quality",
                desc: "Premium ingredients for exceptional experiences",
                icon: "🌿",
              },
              {
                title: "Innovation",
                desc: "Pushing boundaries in fragrance creation",
                icon: "🔬",
              },
            ].map((value, index) => (
              <div
        ...
        >
          <div className="relative p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 text-center border-2 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="absolute bottom-4 right-4 text-6xl font-serif rotate-180">
              "
            </div>
            ...
            <blockquote className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-800 leading-relaxed italic font-light max-w-4xl mx-auto relative z-10">
              Let There Be Fragrance is more than a brand. It's a movement. A
              quiet revolution of self-expression. Let scent be your story. Let
              it linger. Let it speak.
            </blockquote>
